								...
								<div class="card card-custom">
									<div class="card-header flex-wrap py-5">
										...
										<div class="card-toolbar">
											...
											<!--end::Dropdown-->
											<!--begin::Button-->
											<a href="{{ route('product-category.create') }}" class="btn btn-primary font-weight-bolder">
										...
										<table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
											...
											<tbody>
												...
												<tr>
													...
													<td>{{ $row->category }}</td>
													<td> 
                                                     <img src="{{ url('assets/image/category/'.$row->category_image)}}" alt="" width="70px" height="70px">
                                                     ...
                                                     <td>
                                                    	{{-- <a href="">
                                                    	 ...
                                                    	 <a href="{{ route('product-category.edit',$row->id) }}"
                                                    	...
                                                    	{{--   <a href="{{ route('category.edit',$row->id) }}">
                                                    		...
                                                    		<button type="button" class="btn btn-warning">Edit</button>
                                                              ...
                                                              <button type="button" id="deletebtn"
                                                               data-action="{{route('product-category.update',$row->id)}}" data-toggle="modal"
