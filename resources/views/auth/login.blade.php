...
<html lang="en" >
    ...
    <head><base href="../../../">
                <meta charset="utf-8"/>
        <title>Cuirass | Login Page </title>
    ...
    <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
        ...
        <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
            ...
            <a href="#" class="text-center mb-10">
                <img src="{{asset('assets/media/logos/cuirass-logo.png')}}" class="max-h-70px" alt=""/>
            </a>
            <!--end::Aside header-->
            ...
            <div class="login-form login-signin">
                ...
                <form class="form" id="" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="pb-13 pt-lg-0 pt-5">
                        <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Welcome to Cuirass</h3>
